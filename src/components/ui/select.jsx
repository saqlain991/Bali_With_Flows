...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // ✅ Custom height set to 60px
        "h-[64px] border-input data-[placeholder]:text-muted-foreground " +
          ...
          "px-4 text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] " +
